...
public class PHEntityRegistry {
    ...
    public static final DeferredRegister<EntityType<?>> DEF_REG = DeferredRegister.create(ForgeRegistries.ENTITY_TYPES, PetHomeMod.MODID);
    ...
    public static RegistryObject< EntityType<NetEntity>> NET_ENTITY=DEF_REG.register("net_entity",()-> EntityType.Builder
