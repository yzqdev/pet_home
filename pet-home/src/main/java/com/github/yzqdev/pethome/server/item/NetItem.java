...
public class NetItem extends Item {
    ...
    public @NotNull InteractionResult interactLivingEntity(ItemStack stack, Player player, LivingEntity target, InteractionHand hand) {
        ...
        if (this.type == Type.EMPTY) {
            ...
            newerStack.getOrCreateTag().put(PHDataComponents.ENTITY_HOLDER, nbt);
    ...
    public Optional<TooltipComponent> getTooltipImage(ItemStack stack) {
        if (this.type == Type.EMPTY) {
            ...
            if (stack.getOrCreateTag().getCompound(PHDataComponents.ENTITY_HOLDER).isEmpty()) {
                return Optional.empty();
            } else {
                var tag = stack.getOrCreateTag().getCompound(PHDataComponents.ENTITY_HOLDER);
    ...
    public static boolean containsEntity(ItemStack stack) {
        ...
        if (tag==null){
            ...
            return  tag.contains(PHDataComponents.ENTITY_HOLDER);
        }
    ...
    public static CompoundTag getEntityData(ItemStack stack) {
        ...
        if (tag==null){
          ...
          return   containsEntity(stack) ? tag.getCompound(PHDataComponents.ENTITY_HOLDER) : new CompoundTag();
        }
    ...
    public static Entity getEntityFromStack(ItemStack stack, Level world, boolean withInfo) {
        return getEntityFromNBT(stack.getOrCreateTag().getCompound(PHDataComponents.ENTITY_HOLDER), world, withInfo);
    }
