...
public class FeatherEntity extends FishingHook {
    ...
    public FeatherEntity(PlayMessages.SpawnEntity spawnEntity, Level world) {
        this(PHEntityRegistry.FEATHER.get(), world);
    ...
    public boolean isPetAmbulatory(LivingEntity entity){
        ...
        if(entity instanceof IComandableMob && ((IComandableMob) entity).getCommand() == 1 && PetHomeMod.CONFIG.trinaryCommandSystem.get()){
            return false;
        }
        return true;
    }
