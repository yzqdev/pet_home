...
public class DIRenderTypes extends RenderType {
    ...
    protected static final TexturingStateShard PSYCHIC_WALL_TEXTURING = new TexturingStateShard(
    ...
    public static final RenderType IFRAME_GLINT = create("iframe_glint", DefaultVertexFormat.POSITION_TEX,
            VertexFormat.Mode.QUADS, 256, true, true, CompositeState.builder()
                    .setShaderState(RENDERTYPE_ENTITY_GLINT_SHADER)
                    .setTextureState(new TextureStateShard(
                            ResourceLocation.parse(PetHomeMod.MODID + ":textures/immunity_frame_overlay.png"), true,
                            false))
                    .setWriteMaskState(COLOR_DEPTH_WRITE)
                    .setCullState(NO_CULL)
                    .setDepthTestState(EQUAL_DEPTH_TEST)
                    .setTransparencyState(GLINT_TRANSPARENCY)
                    .setTexturingState(IFRAME_TEXTURING)
                    .setOverlayState(OVERLAY)
                    .createCompositeState(true));
    public static final RenderType VOID_CLOUD = create("void_cloud", DefaultVertexFormat.POSITION,
            VertexFormat.Mode.QUADS, 256, false, false, CompositeState.builder()
                    ...
                    .setTextureState(MultiTextureStateShard.builder()
                            ...
                            .add(ResourceLocation.parse(PetHomeMod.MODID + ":textures/void_cloud.png"), false, false)
                            .build())
                    .setLightmapState(LIGHTMAP)
                    .createCompositeState(false));
    public static final RenderType SHADOW_HAND_ENTITY = create("shadow_hand_entity", DefaultVertexFormat.POSITION_TEX,
            VertexFormat.Mode.QUADS, 256, false, false, CompositeState.builder()
                    .setShaderState(RENDERTYPE_ENTITY_GLINT_SHADER)
                    .setTextureState(new TextureStateShard(
                            ResourceLocation.parse(PetHomeMod.MODID + ":textures/shadow_hand.png"), false, false))
                    .setWriteMaskState(COLOR_DEPTH_WRITE)
                    .setTexturingState(SHADOW_HAND_TEXTURING)
                    .setLightmapState(LIGHTMAP)
                    .setCullState(RenderStateShard.NO_CULL)
                    .createCompositeState(false));
    public static final RenderType PSYCHIC_WALL = create("psychic_wall2", DefaultVertexFormat.POSITION_TEX,
            VertexFormat.Mode.QUADS, 256, true, true, CompositeState.builder()
                    .setShaderState(RenderStateShard.RENDERTYPE_GLINT_SHADER)
                    .setTextureState(new TextureStateShard(
                            ResourceLocation.parse(PetHomeMod.MODID + ":textures/psychic_wall_overlay.png"), false,
                            false))
                    .setTexturingState(PSYCHIC_WALL_TEXTURING)
                    .setLightmapState(LIGHTMAP)
                    .setCullState(RenderStateShard.NO_CULL)
                    .setTransparencyState(RenderStateShard.LIGHTNING_TRANSPARENCY)
                    .setDepthTestState(LEQUAL_DEPTH_TEST)
                    .createCompositeState(true));
    public static final RenderType PSYCHIC_WALL_BORDER = create("psychic_wall2", DefaultVertexFormat.POSITION_TEX,
            VertexFormat.Mode.QUADS, 256, true, true, CompositeState.builder()
                    .setShaderState(RenderStateShard.RENDERTYPE_GLINT_SHADER)
                    .setTextureState(new TextureStateShard(
                            ResourceLocation.parse(PetHomeMod.MODID + ":textures/psychic_wall_border.png"), true,
                            false))
                    .setLightmapState(LIGHTMAP)
                    .setCullState(RenderStateShard.NO_CULL)
                    .setTransparencyState(RenderStateShard.LIGHTNING_TRANSPARENCY)
                    .setDepthTestState(LEQUAL_DEPTH_TEST)
                    .createCompositeState(true));
    public static final RenderType HEALING_AURA = create("healing_aura", DefaultVertexFormat.POSITION_TEX,
            VertexFormat.Mode.QUADS, 256, false, false, CompositeState.builder()
                    .setShaderState(RenderStateShard.RENDERTYPE_GLINT_SHADER)
                    .setTextureState(new TextureStateShard(
                            ResourceLocation.parse(PetHomeMod.MODID + ":textures/healing_aura.png"), true, false))
                    .setLightmapState(LIGHTMAP)
                    .setCullState(RenderStateShard.NO_CULL)
                    .setTransparencyState(RenderStateShard.LIGHTNING_TRANSPARENCY)
                    .setWriteMaskState(COLOR_DEPTH_WRITE)
    ...
    public static RenderType getZombieOverlay(ResourceLocation texture, int x, int y) {
        return create("zombie_overlay", DefaultVertexFormat.POSITION_TEX, VertexFormat.Mode.QUADS, 256, true, true,
                CompositeState.builder()
                        .setShaderState(RENDERTYPE_ENTITY_GLINT_SHADER)
                        .setTextureState(new TextureStateShard(
                                ResourceLocation.parse(PetHomeMod.MODID + ":textures/zombie_overlay.png"), false,
                                false))
                        .setWriteMaskState(COLOR_DEPTH_WRITE)
                        .setCullState(NO_CULL)
                        .setDepthTestState(EQUAL_DEPTH_TEST)
    ...
    private static RenderType translucentNoCull() {
        RenderType type = create("translucent_no_cull", DefaultVertexFormat.BLOCK, VertexFormat.Mode.QUADS, 2097152,
