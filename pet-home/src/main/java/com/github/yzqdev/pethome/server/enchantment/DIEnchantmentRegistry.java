...
public class DIEnchantmentRegistry {
    public static final EnchantmentCategory CATEGORY = EnchantmentCategory.create("pet", (item -> item == PHItemRegistry.COLLAR_TAG.get()));
    public static final DeferredRegister<Enchantment> DEF_REG = DeferredRegister.create(ForgeRegistries.ENCHANTMENTS, PetHomeMod.MODID);
public static final  PetEnchantment XP_Transfer=new PetEnchantment("xp_transfer",Enchantment.Rarity.COMMON,3,7);
